...
<div class="row">
	<div class="col-12">
		<p><a href="?action=adminPaliersNB"><i class="fas fa-long-arrow-alt-left"></i> Annuler</a></p>
	</div>
</div>
...
<div class="row">
	<div class="col-12">
		<p><a href="?action=adminPaliersNB&amp;edit"><i class="fas fa-plus-circle"></i> Ajouter un palier</a></p>
	</div>
</div>
<?php } ?>
