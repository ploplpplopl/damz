...
<div class="row">
	<div class="col-12">
		<p class="back"><a href="?action=adminSpiplast">Annuler</a></p>
	</div>
</div>
...
<div class="row">
	<div class="col-12">
		<p class="add"><a href="?action=adminSpiplast&amp;edit">Ajouter un palier</a></p>
	</div>
</div>
<?php } ?>
...
?>
				<li id="listItem_<?php echo $data['id']; ?>">
					...
					<div class="actions">
						<a href="?action=adminSpiplast&amp;edit=<?php echo $data['id']; ?>"><img src="/public/img/icon-mod.png" alt="Modifier" title="Modifier"></a>
						<a href="?action=adminSpiplast&amp;del=<?php echo $data['id']; ?>" onclick="return confirm('Voulez-vous vraiment supprimer cet élément ?')"><img src="/public/img/icon-sup.png" alt="Supprimer" title="Supprimer"></a>
					</div>
				</li>
<?php
	}
