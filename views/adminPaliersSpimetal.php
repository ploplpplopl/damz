...
<div class="row">
	<div class="col-12">
		<p><a href="?action=adminSpimetal"><i class="fas fa-long-arrow-alt-left"></i> Annuler</a></p>
	</div>
</div>
...
<div class="row">
	<div class="col-12">
		<p><a href="?action=adminSpimetal&amp;edit"><i class="fas fa-plus-circle"></i> Ajouter un palier</a></p>
	</div>
</div>
<?php } ?>
...
?>
				<li id="listItem_<?php echo $data['id']; ?>">
					...
					<div class="actions">
						<a href="?action=adminSpimetal&amp;edit=<?php echo $data['id']; ?>" title="Modifier"><i class="fas fa-pen"></i></a>
						<a href="?action=adminSpimetal&amp;del=<?php echo $data['id']; ?>" onclick="return confirm('Voulez-vous vraiment supprimer cet élément ?')" title="Supprimer"><i class="fas fa-trash"></i></a>
					</div>
				</li>
<?php
	}
