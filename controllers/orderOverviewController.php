...
if (isset($_POST['order-btn'])) {
	...
	if (empty($errors)) {
		...
		$stmt = $dbh->prepare('INSERT INTO orders (id_user, id_address, nom_fichier, nb_page, nb_page_nb, nb_page_c, doc_type, couv_ft, couv_fc, couv_fc_type, couv_fc_color, dos_ft, dos_fc, dos_fc_type, dos_fc_color, reliure_type, reliure_color, quantity, rectoverso, tva, total) VALUES (:id_user, :id_address, :nom_fichier, :nb_page, :nb_page_nb, :nb_page_c, :doc_type, :couv_ft, :couv_fc, :couv_fc_type, :couv_fc_color, :dos_ft, :dos_fc, :dos_fc_type, :dos_fc_color, :reliure_type, :reliure_color, :quantity, :rectoverso, :tva, :total)');
		...
		$stmt->bindParam(':nb_page', $_SESSION['file_to_print']['nb_page'], PDO::PARAM_STR);
		$stmt->bindParam(':nb_page_nb', $_SESSION['file_to_print']['nb_page_nb'], PDO::PARAM_STR);
		$stmt->bindParam(':nb_page_c', $_SESSION['file_to_print']['nb_page_c'], PDO::PARAM_STR);
		$stmt->bindParam(':doc_type', $_SESSION['file_to_print']['doc_type'], PDO::PARAM_STR);
		$stmt->bindParam(':couv_ft', $_SESSION['file_to_print']['couv_ft'], PDO::PARAM_STR);
		$stmt->bindParam(':couv_fc', $_SESSION['file_to_print']['couv_fc'], PDO::PARAM_STR);
		$stmt->bindParam(':couv_fc_type', $_SESSION['file_to_print']['couv_fc_type'], PDO::PARAM_STR);
		$stmt->bindParam(':couv_fc_color', $_SESSION['file_to_print']['couv_fc_color'], PDO::PARAM_STR);
		$stmt->bindParam(':dos_ft', $_SESSION['file_to_print']['dos_ft'], PDO::PARAM_STR);
		$stmt->bindParam(':dos_fc', $_SESSION['file_to_print']['dos_fc'], PDO::PARAM_STR);
		$stmt->bindParam(':dos_fc_type', $_SESSION['file_to_print']['dos_fc_type'], PDO::PARAM_STR);
		$stmt->bindParam(':dos_fc_color', $_SESSION['file_to_print']['dos_fc_color'], PDO::PARAM_STR);
		...
		$stmt->bindParam(':quantity', $_SESSION['file_to_print']['quantity'], PDO::PARAM_STR);
		$stmt->bindParam(':rectoverso', $_SESSION['file_to_print']['rectoverso'], PDO::PARAM_STR);
