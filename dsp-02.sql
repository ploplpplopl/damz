...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mer. 19 août 2020 à 12:11
...
CREATE TABLE IF NOT EXISTS `dossier_color` (
  ...
  `type` set('Dossier','Mémoire','Thèse') NOT NULL,
...
INSERT INTO `dossier_color` (`id_dossier_color`, `text`, `hex`, `type`) VALUES
(1, 'Ivoire', 'eceadf', 'Dossier,Mémoire,Thèse'),
(2, 'Blanc', 'ffffff', 'Dossier,Mémoire'),
(3, 'Noir', '000000', 'Dossier,Mémoire'),
(4, 'Gris foncé', '525252', 'Dossier,Mémoire'),
(5, 'Gris clair', 'acacac', 'Dossier,Mémoire,Thèse'),
(6, 'Marron', '7a672c', 'Dossier,Mémoire'),
(7, 'Bleu clair', '6e99e8', 'Dossier,Mémoire,Thèse'),
(8, 'Bleu foncé', '2b4ba6', 'Dossier,Mémoire'),
(9, 'Rouge', 'df1d1d', 'Dossier,Mémoire,Thèse'),
(10, 'Jaune', 'dfd81d', 'Dossier,Mémoire,Thèse'),
(11, 'Bordeau', '6d071a', 'Dossier,Mémoire'),
(12, 'Vert foncé', '076d0e', 'Dossier,Mémoire,Thèse'),
(13, 'Vert clair', '33bc3d', 'Dossier,Mémoire,Thèse'),
(14, 'Orange foncé', 'e1a400', 'Thèse'),
(15, 'Orange clair', 'e8bd49', 'Thèse'),
(16, 'Violet', 'a346e4', 'Thèse'),
(17, 'Rose', 'e446de', 'Thèse'),
(18, 'Cuir 250g', '74452b', 'Dossier,Mémoire');
...
(34, 'admin', 'admin', 'damien@thoorens.fr', '0606060606', 'admin', '$2y$10$jq124lXhBaObEPx4xjvb3OPiC8V97cdExmEXNYoLI7QemuC1miO7i', 'admin', 'be18973e68b14b51d2b3598a947c981ddfe9d16ac1038af1e5303f9bdb17a31e238884df4ea675ac1b556731622e63d45d58', 1, '2020-08-04 09:56:22', NULL),
